...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
      ...
      ($$renderer3) => {
        ...
        for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
          ...
          $$renderer3.option(
            ...
            ($$renderer4) => {
              $$renderer4.push(`${escape_html(provider.label)}`);
            },
            "svelte-1uha8ag"
          );
        }
    ...
    $$renderer2.push(`</div></header> <div class="messages svelte-1uha8ag">`);
    if (messages.length === 0) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="welcome svelte-1uha8ag"><h2 class="svelte-1uha8ag">👋 Welcome to CoverCheck!</h2> <p class="welcome-subtitle svelte-1uha8ag">Ask me anything about South African medical aid plans. I'll provide answers with official sources.</p> <div class="suggestions svelte-1uha8ag"><button class="svelte-1uha8ag">💊 Chronic condition coverage</button> <button class="svelte-1uha8ag">🏥 Hospital benefits</button> <button class="svelte-1uha8ag">👶 Maternity coverage</button> <button class="svelte-1uha8ag">📊 Compare benefits</button></div></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<!--[-->`);
    ...
    $$renderer2.push(`<!--]--></div> <form class="input-form svelte-1uha8ag"><textarea placeholder="Ask me anything about your medical aid or insurance..." rows="1"${attr("disabled", loading, true)} class="svelte-1uha8ag">`);
    const $$body = escape_html(input);
    if ($$body) {
      $$renderer2.push(`${$$body}`);
    }
    $$renderer2.push(`</textarea> <button type="submit"${attr("disabled", !input.trim() || loading, true)} class="svelte-1uha8ag">${escape_html("→")}</button></form></div>`);
  });
}
export {
  _page as default
